...
import com.t2.sudoku.SudokuPuzzlesFragment;
import com.t2.sudoku.SudokuPuzzlesFragment.OnSudokuPuzzleSelectedListener;
import com.t2.sudoku.db.SudokuContract.Sudoku.Difficulty;
import com.t2.vhb.ActionBarActivity;
import com.t2.vhb.R;

public class SudokuChangePuzzleActivity extends ActionBarActivity implements ActionBar.TabListener,
        OnSudokuPuzzleSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sudoku_change_puzzle);
        ...
        for (int i = 0; i < mPagerAdapter.getCount(); i++) {
            ActionBar.Tab tab = actionBar.newTab().setText(mPagerAdapter.getPageTitle(i)).setTabListener(this)
                    .setContentDescription(String.format("%s puzzles tab", mPagerAdapter.getPageTitle(i)));
            actionBar.addTab(tab);
        }

        setTitle("Sudoku Puzzles");
    }

    @Override
    public void onSudokuPuzzleSelected(int id) {
    ...
    public class DifficultyPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return SudokuPuzzlesFragment.createInstance(mDifficulties[position]);
        }
