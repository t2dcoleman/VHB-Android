...
public class SudokuContract {
    ...
    public static final class Sudoku implements BaseColumns {
        ...
        public static final String CONTENT_MIME_TYPE = DIR_MIME_TYPE_BASE + "/vnd.t2.sudoku.sudoku";
        public static final String CONTENT_ITEM_MIME_TYPE = ITEM_MIME_TYPE_BASE + "/vnd.t2.sudoku.sudoku";
