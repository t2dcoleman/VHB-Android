...
public class PreferenceManagerCompat {
	...
	static PreferenceManager newInstance(Activity activity, int firstRequestCode) {
		try {
			...
			Timber.tag(TAG).w(e, "Couldn't call constructor PreferenceManager by reflection");
		}
		return null;
	}
	...
	static void setOnPreferenceTreeClickListener(PreferenceManager manager, final OnPreferenceTreeClickListener listener) {
		try {
			...
			Timber.tag(TAG).w(e, "Couldn't set PreferenceManager.mOnPreferenceTreeClickListener by reflection");
		}
	}
	...
	static PreferenceScreen inflateFromIntent(PreferenceManager manager, Intent intent, PreferenceScreen screen) {
		try {
			...
			Timber.tag(TAG).w(e, "Couldn't call PreferenceManager.inflateFromIntent by reflection");
		}
		return null;
	}
	...
	static PreferenceScreen inflateFromResource(PreferenceManager manager, Activity activity, int resId, PreferenceScreen screen) {
		try {
			...
			Timber.tag(TAG).w(e, "Couldn't call PreferenceManager.inflateFromResource by reflection");
		}
		return null;
	}
	...
	static PreferenceScreen getPreferenceScreen(PreferenceManager manager) {
		try {
			...
			Timber.tag(TAG).w(e, "Couldn't call PreferenceManager.getPreferenceScreen by reflection");
		}
		return null;
	}
	...
	static void dispatchActivityResult(PreferenceManager manager, int requestCode, int resultCode, Intent data) {
		try {
			...
			Timber.tag(TAG).w(e, "Couldn't call PreferenceManager.dispatchActivityResult by reflection");
		}
	}
	...
	static void dispatchActivityStop(PreferenceManager manager) {
		try {
			...
			Timber.tag(TAG).w(e, "Couldn't call PreferenceManager.dispatchActivityStop by reflection");
		}
	}
	...
	static void dispatchActivityDestroy(PreferenceManager manager) {
		try {
			...
			Timber.tag(TAG).w(e, "Couldn't call PreferenceManager.dispatchActivityDestroy by reflection");
		}
	}
	...
	static boolean setPreferences(PreferenceManager manager, PreferenceScreen screen) {
		try {
			...
			Timber.tag(TAG).w(e, "Couldn't call PreferenceManager.setPreferences by reflection");
		}
		return false;
	}
